          ...
          <div className="mt-3 space-y-2">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <button
                ...
                className="shrink-0 px-2.5 py-1.5 btn-primary text-[10px] font-black rounded"
              >
                OK
              </button>
            </div>
            ...
            <div className="bg-white border border-gray-200 px-3 py-2.5 flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="md:hidden btn-primary px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5"
                >
            ...
            {filteredListings.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl p-12 text-center border border-gray-200">
                ...
                <button
                  ...
                  className="mt-5 px-5 py-2.5 btn-primary font-extrabold text-xs rounded-full"
                >
                  Clear Filters
                </button>
              </div>
