      ...
      <div className="p-3 border-b border-gray-100 bg-white sticky top-0 z-20">
        ...
        {step < 10 && (
          <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#FF3F6C] transition-all duration-300"
      ...
      <div className="p-4 flex-1 overflow-y-auto space-y-5">
              ...
              {categories.map(cat => (
                <button
                  ...
                  className={`p-3 rounded-xl border text-left flex items-center gap-3 transition-all ${
                    categoryId === cat.id
                      ? 'border-[#FF3F6C] bg-pink-50 text-[#FF3F6C] font-bold shadow-2xs'
                      : 'border-gray-200 hover:border-pink-200 text-gray-800'
                  }`}
                >
                  <img
                    src={cat.imageUrl}
        ...
        {step === 3 && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 pt-2">
              {images.map((img, i) => (
                <div key={i} className="relative aspect-square rounded-xl overflow-hidden border border-gray-200">
                  ...
                  {i === 0 && (
                    <span className="absolute top-1 left-1 bg-[#FF3F6C] text-white text-[9px] font-bold px-1 rounded-xs">
                      COVER
                    </span>
                  )}
                  <button
              ...
              <button
                ...
                className="aspect-square rounded-xl border-2 border-dashed border-pink-300 bg-pink-50/50 flex flex-col items-center justify-center text-[#FF3F6C] font-bold text-xs gap-1 hover:bg-pink-100/50 transition-colors"
              >
            ...
            <button
              ...
              className="w-full mt-4 py-3 bg-[#FF3F6C] text-white font-bold text-xs rounded-xl shadow-md disabled:opacity-50"
            >
              Continue to Details
            </button>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-200 rounded-xl text-xs text-gray-900 focus:outline-none focus:border-[#FF3F6C]"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-[#FF3F6C] text-white font-bold text-xs rounded-xl shadow-md disabled:opacity-50"
            >
              Next: Pricing
            </button>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-200 rounded-xl text-base font-bold text-gray-900 focus:outline-none focus:border-[#FF3F6C]"
              />
            </div>
            ...
            <button
              onClick={() => setStep(6)}
              className="w-full py-3 bg-[#FF3F6C] text-white font-bold text-xs rounded-xl shadow-md"
            >
              Next: Item Condition
            </button>
          </div>
        ...
        {step === 9 && (
          <div className="space-y-3">
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden p-3 bg-gray-50 space-y-2">
              ...
              <div className="text-lg font-black text-[#FF3F6C]">
            ...
            <button
              ...
              className="w-full py-3 bg-[#FF3F6C] hover:bg-[#e0345b] text-white font-black text-sm rounded-xl shadow-lg transition-all"
            >
              Publish Free Ad Now
            </button>
          </div>
        ...
        {step === 10 && (
          <div className="text-center py-8 space-y-4">
            ...
            {/* Optional Boost Card */}
            <div className="p-4 bg-gradient-to-r from-pink-500 to-rose-600 text-white rounded-2xl text-left space-y-2 shadow-lg">
              ...
              <button
                ...
                className="w-full py-2 bg-white text-[#FF3F6C] font-extrabold text-xs rounded-xl shadow-md"
              >
                Boost Ad (250 ETB)
              </button>
            </div>
