...
export const VendorsDashboardView: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    const chats = chatThreads.filter(t =>
      ...
      <div className="bg-[#F4F4F5] min-h-screen pb-24">
        ...
        <div className="max-w-lg mx-auto px-4 py-16 text-center space-y-4">
          ...
          <p className="text-sm text-gray-500 max-w-sm mx-auto">
            Sign in to post products, track views & chats, boost ads, and manage your store like a pro.
          </p>
          <button
            type="button"
            onClick={() => setActiveView('auth')}
            className="w-full max-w-xs mx-auto py-3 bg-black text-white font-black text-sm rounded-xl"
          >
            Sign in to continue
          </button>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-3 md:px-6 py-4 space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
          {[
            ...
            { label: 'Buyer chats', value: stats.chats, icon: MessageSquare, hint: 'Inquiries' },
            {
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  <div className="rounded-xl bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-4">
                    ...
                    <p className="text-sm font-semibold leading-relaxed text-zinc-200">
                      ...
                      <span className="text-white">2.4× more chats</span> in Bole & Kazanchis.
                    </p>
                    <button
                      type="button"
                      onClick={goPostProduct}
                ...
                {filteredListings.length === 0 ? (
                  <div className="text-center py-12 space-y-3">
                    ...
                    <button
                      type="button"
                      onClick={goPostProduct}
                      className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-black text-white text-xs font-black rounded-xl"
                    >
