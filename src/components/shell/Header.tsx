    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-2xs">
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-8">
        ...
        >
          ...
          <button
            type="submit"
            className="btn-primary px-5 py-2 flex items-center justify-center transition-colors shrink-0"
          >
        ...
        <div className="flex items-center gap-6 shrink-0 text-gray-900">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1.5 -right-3 btn-primary text-[9px] font-black w-4 h-4 rounded-full flex items-center justify-center shadow-2xs">
                {cartCount}
              </span>
            )}
          </button>
          ...
          {isLoggedIn ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 btn-primary font-bold text-xs rounded-lg transition-colors shadow-2xs"
            >
          ...
          <button
            ...
            className="btn-primary font-black text-xs px-4 py-2 rounded-xs flex items-center gap-1 shadow-sm transition-transform active:scale-95"
          >
