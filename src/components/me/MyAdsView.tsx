...
import { ArrowLeft, Eye, MessageSquare, Edit, Flame, Trash2, CheckCircle2 } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 text-[10px] text-gray-400 mt-1">
                  ...
                  <span>•</span>
                  <span className="flex items-center gap-0.5"><MessageSquare className="w-3 h-3" /> 5 chats</span>
                </div>
              </div>
            </div>
